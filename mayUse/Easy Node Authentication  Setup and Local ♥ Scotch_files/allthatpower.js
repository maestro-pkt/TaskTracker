$(document).ready(function() {
	...
	// SIDEBAR AFFIX WIDTH =====================================================
	// =========================================================================
	var sidePrimaryWidth = $('#sidebar-primary .sidebar-email').width();
	$('#sidebar-primary .sidebar-sticky').width(sidePrimaryWidth + 60);
...
function addAnchors() {
	...
	$.each($('.article-content h2'), function(index, value) {
		...
		$(this).attr('id', link);
		$(this).html('<a href="#' + link + '"><span class="heading-link fa fa-link"></span> ' + $(this).html() + '</a>');
